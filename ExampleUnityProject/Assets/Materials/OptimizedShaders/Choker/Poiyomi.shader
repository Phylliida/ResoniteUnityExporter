Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/ec4afcc60ead43949a8b77fa6333456f"
{
	Properties
	{
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				switch(float(1))
				{
					case 0:
					{
						...
						matcapUV = noSknewViewNormal.rg * float(0.315) + 0.5;
						break;
					}
					case 1:
					{
						...
						matcapUV = float2(dot(worldViewRight, normal0), dot(worldViewUp, normal0)) * float(0.315) + 0.5;
						break;
					}
					case 2:
					{
				...
				blendMatcap(poiLight, poiFragData, float(0), float(0), float(0), float(1), float(0), matcap, matcapMask, float(0), float(0)
				#ifdef POI_BLACKLIGHT
