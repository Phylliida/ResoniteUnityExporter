Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/c688e64dba9c46143b673bd1d0e7f1fc"
{
	Properties
	{
 ...
 #define PROP_MATCAP 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, float(0.07), float(0), float(0), float(0), float(0), matcap, matcapMask, float(0), float(0)
				#ifdef POI_BLACKLIGHT
