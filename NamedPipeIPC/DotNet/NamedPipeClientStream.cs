...
namespace System.IO.Pipes
{
    ...
    public sealed partial class NamedPipeClientStreamDotNet : PipeStreamDotNet
    {
        ...
        public NamedPipeClientStreamDotNet(String serverName, String pipeName, PipeDirection direction)
            : this(serverName, pipeName, direction, PipeOptions.None, TokenImpersonationLevel.None, HandleInheritability.None)
        {
        }

        public NamedPipeClientStreamDotNet(String serverName, String pipeName, PipeDirection direction, PipeOptions options)
            ...
            : base(direction, 0)
        {
            ...
            if (serverName == null)
            {
                throw new ArgumentNullException(nameof(serverName), Strings.ArgumentNull_ServerName);
            }
            ...
            {
                throw new ArgumentException(Strings.Argument_EmptyServerName);
            }
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(impersonationLevel), Strings.ArgumentOutOfRange_ImpersonationInvalid);
            }
        ...
        public NamedPipeClientStreamDotNet(PipeDirection direction, bool isAsync, bool isConnected, SafePipeHandle safePipeHandle)
            : base(direction, 0)
        {
        ...
        public void Connect(int timeout)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(timeout), Strings.ArgumentOutOfRange_InvalidTimeout);
            }
        ...
        private void CheckConnectOperationsClient()
        {
            ...
            {
                throw new InvalidOperationException(Strings.InvalidOperation_PipeAlreadyConnected);
            }
