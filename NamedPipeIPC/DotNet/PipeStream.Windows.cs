...
namespace System.IO.Pipes
{
    public abstract partial class PipeStreamDotNet : Stream
    {
        ...
        internal static string GetPipePath(string serverName, string pipeName)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(pipeName), Strings.ArgumentOutOfRange_AnonymousReserved);
            }
        ...
        internal void ValidateHandleIsPipe(SafePipeHandle safePipeHandle)
        {
            ...
            {
                throw new IOException(Strings.IO_InvalidPipeHandle);
            }
        }
        ...
        private unsafe int ReadCore(Span<byte> buffer)
        {
            ...
            Debug.Assert(r >= 0, "PipeStreamDotNet's ReadCore is likely broken.");
        ...
        {
            var completionSource = new ReadWriteCompletionSourceDotNet(this, buffer, isWrite: false);
        ...
        private unsafe void WriteCore(ReadOnlySpan<byte> buffer)
        {
            ...
            Debug.Assert(r >= 0, "PipeStreamDotNet's WriteCore is likely broken.");
        }

        private Task WriteAsyncCore(ReadOnlyMemory<byte> buffer, CancellationToken cancellationToken)
        {
            var completionSource = new ReadWriteCompletionSourceDotNet(this, buffer, isWrite: true);
            int errorCode = 0;
        ...
        public virtual PipeTransmissionMode ReadMode
        {
            ...
            set
            {
                // Nothing fancy here.  This is just a wrapper around the Win32 API.  Note, that NamedPipeServerStreamDotNet
                // and the AnonymousPipeStreams override this.

                CheckPipePropertyOperations();
                if (value < PipeTransmissionMode.Byte || value > PipeTransmissionMode.Message)
                {
                    throw new ArgumentOutOfRangeException(nameof(value), Strings.ArgumentOutOfRange_TransmissionModeByteOrMsg);
                }
        ...
        internal static unsafe Interop.Kernel32.SECURITY_ATTRIBUTES GetSecAttrs(HandleInheritability inheritability, PipeSecurityDotNet PipeSecurityDotNet, ref GCHandle pinningHandle)
        {
            Interop.Kernel32.SECURITY_ATTRIBUTES secAttrs = default(Interop.Kernel32.SECURITY_ATTRIBUTES);
            secAttrs.nLength = (uint)sizeof(Interop.Kernel32.SECURITY_ATTRIBUTES);
            ...
            if (PipeSecurityDotNet != null)
            {
                byte[] securityDescriptor = PipeSecurityDotNet.GetSecurityDescriptorBinaryForm();
        ...
        internal Exception WinIOError(int errorCode)
        {
            switch (errorCode)
            {
                ...
                case Interop.Errors.ERROR_NO_DATA:
                    ...
                    return new IOException(Strings.IO_PipeBroken, Win32Marshal.MakeHRFromErrorCode(errorCode));
