...
namespace System.IO.Pipes
{
    ...
    public sealed partial class NamedPipeClientStreamDotNet : PipeStreamDotNet
    {
            ...
            , CancellationToken cancellationToken)
        {
            ...
            int access = 0;
            if ((PipeDirectionDotNet.In & _direction) != 0)
            {
                access |= Interop.Kernel32.GenericOperations.GENERIC_READ;
            }
            if ((PipeDirectionDotNet.Out & _direction) != 0)
            {
            ...
            // Success! 
            InitializeHandle(handle, false, (_pipeOptions & PipeOptionsDotNet.Asynchronous) != 0);
