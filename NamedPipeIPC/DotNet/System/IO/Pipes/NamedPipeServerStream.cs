...
namespace System.IO.Pipes
{
    ...
    public sealed partial class NamedPipeServerStreamDotNet : PipeStreamDotNet
    {
        ...
        public NamedPipeServerStreamDotNet(String pipeName)
            : this(pipeName, PipeDirectionDotNet.InOut, 1, PipeTransmissionModeDotNet.Byte, PipeOptionsDotNet.None, 0, 0, HandleInheritability.None)
        {
        }

        [SecuritySafeCritical]
        public NamedPipeServerStreamDotNet(String pipeName, PipeDirectionDotNet direction)
            : this(pipeName, direction, 1, PipeTransmissionModeDotNet.Byte, PipeOptionsDotNet.None, 0, 0, HandleInheritability.None)
        {
        }

        [SecuritySafeCritical]
        public NamedPipeServerStreamDotNet(String pipeName, PipeDirectionDotNet direction, int maxNumberOfServerInstances)
            : this(pipeName, direction, maxNumberOfServerInstances, PipeTransmissionModeDotNet.Byte, PipeOptionsDotNet.None, 0, 0, HandleInheritability.None)
        {
        }

        [SecuritySafeCritical]
        public NamedPipeServerStreamDotNet(String pipeName, PipeDirectionDotNet direction, int maxNumberOfServerInstances, PipeTransmissionModeDotNet transmissionMode)
            : this(pipeName, direction, maxNumberOfServerInstances, transmissionMode, PipeOptionsDotNet.None, 0, 0, HandleInheritability.None)
        {
        }

        [SecuritySafeCritical]
        public NamedPipeServerStreamDotNet(String pipeName, PipeDirectionDotNet direction, int maxNumberOfServerInstances, PipeTransmissionModeDotNet transmissionMode, PipeOptionsDotNet options)
            : this(pipeName, direction, maxNumberOfServerInstances, transmissionMode, options, 0, 0, HandleInheritability.None)
        {
        }

        [SecuritySafeCritical]
        public NamedPipeServerStreamDotNet(String pipeName, PipeDirectionDotNet direction, int maxNumberOfServerInstances, PipeTransmissionModeDotNet transmissionMode, PipeOptionsDotNet options, int inBufferSize, int outBufferSize)
        ...
        /// FILE_FLAG_OVERLAPPED option. PipeOptionsDotNet enum doesn't expose FIRST_PIPE_INSTANCE option because
        ...
        [SecuritySafeCritical]
        private NamedPipeServerStreamDotNet(String pipeName, PipeDirectionDotNet direction, int maxNumberOfServerInstances,
        ...
        [SecuritySafeCritical]
        public NamedPipeServerStreamDotNet(PipeDirectionDotNet direction, bool isAsync, bool isConnected, SafePipeHandle safePipeHandle)
            : base(direction, PipeTransmissionModeDotNet.Byte, 0)
        {
