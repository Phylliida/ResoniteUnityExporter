...
namespace System.IO.Pipes
{
    public abstract partial class PipeStreamDotNet : Stream
    {
        ...
        public virtual PipeTransmissionModeDotNet TransmissionMode
        {
            [SecurityCritical]
            ...
            get
            {
                ...
                if (_isFromExistingHandle)
                {
                    ...
                    if ((pipeFlags & Interop.Kernel32.PipeOptionsDotNet.PIPE_TYPE_MESSAGE) != 0)
                    {
                        return PipeTransmissionModeDotNet.Message;
                    }
                    else
                    {
                        return PipeTransmissionModeDotNet.Byte;
                    }
                }
                else
                {
        ...
        public virtual int OutBufferSize
        {
            ...
            get
            {
                ...
                if (_pipeDirection == PipeDirectionDotNet.Out)
                {
        ...
        public virtual PipeTransmissionModeDotNet ReadMode
        {
            [SecurityCritical]
            get
            {
        ...
        private void UpdateReadMode()
        {
            ...
            if ((flags & Interop.Kernel32.PipeOptionsDotNet.PIPE_READMODE_MESSAGE) != 0)
            {
                _readMode = PipeTransmissionModeDotNet.Message;
            }
            else
            {
                _readMode = PipeTransmissionModeDotNet.Byte;
            }
        }
