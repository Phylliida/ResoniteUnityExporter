...
namespace BepuPhysics.Constraints
{
    ...
    public interface IOneBodyConstraintDescription<TDescription> : IConstraintDescription<TDescription> where TDescription : struct, IOneBodyConstraintDescription<TDescription>
    {
    }
    ...
    /// <typeparam name="TDescription">Type of the description.</typeparam>
    /// <remarks>This and the other body-count aware interfaces exist to give the compiler a way to report errors when using Solver.Add with different body counts.</remarks>
    public interface ITwoBodyConstraintDescription<TDescription> : IConstraintDescription<TDescription> where TDescription : struct, ITwoBodyConstraintDescription<TDescription>
    {
    }
    ...
    /// <typeparam name="TDescription">Type of the description.</typeparam>
    /// <remarks>This and the other body-count aware interfaces exist to give the compiler a way to report errors when using Solver.Add with different body counts.</remarks>
    public interface IThreeBodyConstraintDescription<TDescription> : IConstraintDescription<TDescription> where TDescription : struct, IThreeBodyConstraintDescription<TDescription>
    {
    }
    ...
    /// <typeparam name="TDescription">Type of the description.</typeparam>
    /// <remarks>This and the other body-count aware interfaces exist to give the compiler a way to report errors when using Solver.Add with different body counts.</remarks>
    public interface IFourBodyConstraintDescription<TDescription> : IConstraintDescription<TDescription> where TDescription : struct, IFourBodyConstraintDescription<TDescription>
    {
    }
}
