...
{
    /// <summary>
    /// Defines a type that is capable of pooling blocks of struct memory.
    /// </summary>
    public interface IstructMemoryPool
    {
        /// <summary>
        ...
        void TakeAtLeast<T>(int count, out Buffer<T> buffer) where T : struct;
        /// <summary>
